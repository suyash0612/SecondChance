...
const st = StyleSheet.create({
  ...
  heroT: { fontSize: F.xl, fontWeight: "700", color: "#FFFFFF", textAlign: "center" },
  heroS: { fontSize: F.sm, color: "#FFFFFF", textAlign: "center", marginTop: S.sm, lineHeight: 20, maxWidth: 280 },
